 ...
 *
 * Adapted for Cooperative Multitasking for IC2C2 not yet for IC2C1
 *****************************************************************************/
...
/* Return values for Cooperatuve Multitasking */
#define Busy -3
#define Finished 0
...
Remarks            : This Macro will be in a wait state until Start Condition Enable bit,
                     ...
                     peripheral must be in Idle state before an I2C operation can be initiated
                     or write collision will be generated.
                     This is the adapted version for Cooperative multitasking
***********************************************************************************************/
