...
#if defined (__dsPIC33E__) && (defined (_SENT1IF) || defined (_AC1IF))
#define I2C1CON1_VALUE              0x0000
#define I2C1CON2_VALUE              0x0000
#else
...
/* I2C1CON (or I2C1CON1) register Configuration bit definitions */
...
#if defined (__dsPIC33E__) && (defined (_SENT1IF) || defined (_AC1IF))
#define I2C1_RESERVED_ADDR_EN		0xFFFF	 /*Strict reserved addressing is enforced */
#define I2C1_RESERVED_ADDR_DIS		0xF7FF   /*Reserved addressing would be Acknowledged */
#endif
...
/* I2C1CON2 register Configuration bit definitions */

#define I2C1_STOP_COND_INT_EN		0x0040	  /*Enables interrupt on detection of Stop condition*/
#define I2C1_STOP_COND_INT_DIS		0x0000	  /*Stop detection interrupts are disabled*/

#define I2C1_START_COND_INT_EN		0x0020	  /*Enables interrupt on detection of Start or Restart conditions*/
#define I2C1_START_COND_INT_DIS		0x0000	  /*Stop detection interrupts are disabled*/

#define I2C1_BUF_OVERWRITE_EN		0x0010	  /*The I2CxRCV register bit is updated ignoring the state of the I2COV bit*/
#define I2C1_BUF_OVERWRITE_DIS		0x0000	  /*The I2CxRCV register bit is only updated when I2COV is clear*/

#define I2C1_SDA_HOLD_TIME_SEL_300	0x0008	  /*Minimum of 300 ns hold time on SDAx after the falling edge of SCLx*/
#define I2C1_SDA_HOLD_TIME_SEL_100	0x0000	  /*Minimum of 100 ns hold time on SDAx after the falling edge of SCLx*/

#define I2C1_SLAVE_BUS_COL_DETECT_EN	0x0004	  /*Slave bus collision interrupts are enabled*/
#define I2C1_SLAVE_BUS_COL_DETECT_DIS	0x0000	  /*Slave bus collision interrupts are disabled*/

#define I2C1_ADDR_HOLD_EN			0x0002	  /*Address holding is enabled*/
#define I2C1_ADDR_HOLD_DIS			0x0000	  /*Address holding is disabled*/

#define I2C1_DATA_HOLD_EN			0x0001	  /*Data holding is enabled*/
#define I2C1_DATA_HOLD_DIS			0x0000	  /*Data holding is disabled*/
...
#if defined (__dsPIC33E__) && (defined (_SENT1IF) || defined (_AC1IF))
void OpenI2C1(unsigned int,unsigned int,unsigned int) __attribute__ ((section (".libperi")));
#else
...
#if defined (__dsPIC33E__) && (defined (_SENT1IF) || defined (_AC1IF))
#define I2C2CON1_VALUE              0x0000
#define I2C2CON2_VALUE              0x0000
#else
...
/* I2C2CON (or I2C2CON1) register Configuration bit definitions */
...
#if defined (__dsPIC33E__) && (defined (_SENT1IF) || defined (_AC1IF))
#define I2C2_RESERVED_ADDR_EN		0xFFFF	 /*Strict reserved addressing is enforced */
#define I2C2_RESERVED_ADDR_DIS		0xF7FF   /*Reserved addressing would be Acknowledged */
#endif
...
#define I2C2_STOP_COND_INT_EN		0x0040	  /*Enables interrupt on detection of Stop condition*/
#define I2C2_STOP_COND_INT_DIS		0x0000	  /*Stop detection interrupts are disabled*/

#define I2C2_START_COND_INT_EN		0x0020	  /*Enables interrupt on detection of Start or Restart conditions*/
#define I2C2_START_COND_INT_DIS		0x0000	  /*Stop detection interrupts are disabled*/

#define I2C2_BUF_OVERWRITE_EN		0x0010	  /*The I2CxRCV register bit is updated ignoring the state of the I2COV bit*/
#define I2C2_BUF_OVERWRITE_DIS		0x0000	  /*The I2CxRCV register bit is only updated when I2COV is clear*/

#define I2C2_SDA_HOLD_TIME_SEL_300	0x0008	  /*Minimum of 300 ns hold time on SDAx after the falling edge of SCLx*/
#define I2C2_SDA_HOLD_TIME_SEL_100	0x0000	  /*Minimum of 100 ns hold time on SDAx after the falling edge of SCLx*/

#define I2C2_SLAVE_BUS_COL_DETECT_EN	0x0004	  /*Slave bus collision interrupts are enabled*/
#define I2C2_SLAVE_BUS_COL_DETECT_DIS	0x0000	  /*Slave bus collision interrupts are disabled*/

#define I2C2_ADDR_HOLD_EN			0x0002	  /*Address holding is enabled*/
#define I2C2_ADDR_HOLD_DIS			0x0000	  /*Address holding is disabled*/

#define I2C2_DATA_HOLD_EN			0x0001	  /*Data holding is enabled*/
#define I2C2_DATA_HOLD_DIS			0x0000	  /*Data holding is disabled*/
...
#if defined (__dsPIC33E__) && (defined (_SENT1IF) || defined (_AC1IF))
void OpenI2C2(unsigned int,unsigned int,unsigned int) __attribute__ ((section (".libperi")));
#else
